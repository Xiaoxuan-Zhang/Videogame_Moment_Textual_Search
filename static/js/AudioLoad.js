var AudioManager = function () {
  ...
  this.initAudio = function() {
    ...
    // });
    //g_expectedActions += 1;
    this.audioLoader.load( 'static/sound/OnShow.mp3', function( buffer ) {
    ...
    //g_expectedActions += 1;
    this.audioLoader.load( 'static/sound/OnSelect.wav', function( buffer ) {
    ...
    //g_expectedActions += 1;
    this.audioLoader.load( 'static/sound/OnSelect.mp3', function( buffer ) {
    ...
    //g_expectedActions += 1;
    this.audioLoader.load( 'static/sound/OnNext.wav', function( buffer ) {
